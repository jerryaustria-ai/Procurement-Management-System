...
export function serializePurchaseRequest(request) {
  ...
  return {
    ...
    propertyProject: request.propertyProject,
    requester: request.requesterName,
    requesterEmail: request.requesterEmail,
    amount: request.amount,
    currency: request.currency,
    modeOfRelease: request.modeOfRelease,
    bankName: request.bankName,
    accountName: request.accountName,
    accountNumber: request.accountNumber,
    checkNumber: request.checkNumber,
    checkDate: request.checkDate,
    digitalWalletProvider: request.digitalWalletProvider,
    digitalWalletMobileNumber: request.digitalWalletMobileNumber,
    ...
    rfpDraft: request.rfpDraft
        ? {
          ...
          dateReleased: request.rfpDraft.dateReleased ?? null,
